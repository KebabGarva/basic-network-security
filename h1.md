...
- Someone on our team doesn't follow our protocol
  - Sends a key to an untrusted recipient without permission
...
- A zero-trust model
  - Everything is through Steam's [curator connect](https://partner.steamgames.com/doc/marketing/curators)
...
- Sharing our ideas with other indie developers
  - Developing a possible standard for sharing product keys
